...
const AboutSection = () => {
  return (
    <section id="about" className="bg-[#f8f9fa] py-16 md:py-24">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/3 flex justify-center">
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              ...
              <div className="absolute inset-[5px] rounded-full overflow-hidden border-4 border-white">
                <img 
...
const AboutCard = ({ title, description, icon, color }: AboutCardProps) => {
  return (
    <div className="glass-card rounded-xl p-6 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
